                ...
                <Navbar bg="light" expand="lg">
                    <Container>
                        ...
                        <Form className="linkUser">
                            <div className="login">
                                <Link to="/login">
                                    <RiUserFollowFill /> login
                                </Link>
                            </div>
                            <div className="signUplink">
                                <Link to="/signup">
                                    <RiUserAddFill /> signUp
                                </Link>
                            </div>
                            <Form.Control
                                type="search"
                            ...
                            <span className="linkAddtocard">
                                <Link to="/addtocart" className="addToCardLink">
                                    {" "}
                                    <IoCartSharp />
                                </Link>

                                <div className="heartNav">
                                    <Link to="/favorite" className="heartLink">
                                        {" "}
                                        <FaHeart />
                                    </Link>
                                </div>
                    ...
                    <Offcanvas show={show} onHide={handleClose}>
                        ...
                        <Offcanvas.Body>
                            <ListGroup className="linkMobile">
                                <Link to="/myorder">
                                    <RiShoppingBasketFill className="icon" /> MyOrder
                                </Link>
                                <Link to="#">
                                    <AiOutlineSetting className="icon" /> About
                                </Link>
                                <Link to="/login">
                                    <RiUserFollowFill className="icon" /> login
                                </Link>
                                <Link to="/signup">
                                    <RiUserAddFill className="icon" /> signUp
                                </Link>
                                <Link to="/favorite">
